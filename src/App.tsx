            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.05 }}
              ...
              <div className="mt-auto flex flex-col gap-2">
                {prospect.link ? (
                  ...
                  <a href={prospect.sourceUrl} target="_blank" rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 w-full py-3 bg-slate-900 text-white rounded-xl text-sm font-bold hover:bg-slate-700 transition-all">
                    <ExternalLink className="w-4 h-4" /> Read Article
                  </a>
                ) : prospect.sourceArticle ? (
                  <button disabled className="flex items-center justify-center gap-2 w-full py-3 bg-slate-900 text-white rounded-xl text-sm font-bold opacity-40 cursor-not-allowed">
                    Read Article
                  </button>
                ) : null}
